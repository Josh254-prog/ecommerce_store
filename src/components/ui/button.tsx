  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        brand: "bg-gradient-primary text-brand-foreground shadow-brand hover:shadow-lg transform hover:-translate-y-0.5 transition-spring",
        cart: "bg-brand text-brand-foreground hover:bg-brand/90 shadow-smooth transition-smooth",
        hero: "bg-gradient-primary text-brand-foreground px-8 py-6 text-lg font-semibold shadow-brand hover:shadow-lg transform hover:-translate-y-1 transition-spring",
      },
      size: {
